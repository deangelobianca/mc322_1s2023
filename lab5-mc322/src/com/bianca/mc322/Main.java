...
public class Main {
	...
	public static void main(String[] args) throws ParseException {
		...
		while (true) {
			...
			case 6:
				...
				break;
			case 7:
				System.out.println(menuCondutor().toString());
				break;
			case 8:
				System.exit(0);
			default:
	...
	// TODO: Trasnformar menuCliente em menuCondutor (pegar lista de condutores através do cliente; ideia > puxar menuCliente)
	private static Cliente menuCondutor() {
		@SuppressWarnings("resource")
		Scanner keyboard = new Scanner(System.in);
		System.out.println("Escolha um condutor:");
	...
	private static Cliente gerarClientePF() throws ParseException {
		...
		return new ClientePF(CPF, dataNascimento, nomeClientePF, enderecoClientePF, educacaoClientePF, generoClientePF,
				classeEcononomicaClientePF, dataLicenca, seguradora);
	}
	...
	private static Cliente gerarClientePJ() throws ParseException {
		...
		System.out.println("Qtd de funcionarios:");
		int qtdFuncionarios = keyboard.nextInt();
		
		Seguradora seguradora = menuSeguradora();

		return new ClientePJ(CNPJ, dataFundacao, nomeClientePJ, enderecoClientePJ, qtdFuncionarios, seguradora);
	}
	...
	private static Sinistro gerarSinistro(Cliente cliente, Veiculo veiculo, Seguradora seguradora)
		...
		return new Sinistro(dataSinistro, enderecoSinistro, cliente, seguradora);
	}
